...
**pc** - high-level language compiler, generates .pi text files\
**pi** - intermediate language compiler designed to be generated by **pc**, generates .po object files and .pmap debugging information files\
